...
//	$rootScope.currentLocation = navigator.geolocation.getCurrentPosition(function (position) {
//            var c = position.coords;
//            //$rootScope.currentLocation = { lat: c.latitude, lon: c.longitude };
//            return  { lat: 31.110447, lon: 121.374097};
//        });
//});

//angular.bootstrap(document.getElementById("testId"),"app");
...
app.controller("appCtrl", function ($scope) {
    ...
    $scope.gotoLocation = function (lat, lon) {
        if ($scope.lat != lat || $scope.lon != lon) {
            ...
            //$scope.currentMarkers = [{lat: lat, lon: lon}];
